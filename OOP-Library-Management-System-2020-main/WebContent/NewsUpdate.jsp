...
<br><br>
            <header>
                <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
                    <div>
                        <a href="#" class="navbar-brand">Update News Detail</a>
                    </div>
	...
	<div class = "container">
		<div class = "card text-white special-card">
			<div class = "card-body">
					<form action="updateN" method ="post" enctype="multipart/form-data" >
...
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" id="topic"  placeholder="Enter the Book name" name = "topic" value = "<%= topic %>">
 </div>
 
  <div class="form-group">
    <label for="description">News Description</label>
    <input type="text" class="form-control" id="description"  placeholder="Enter name of author" name = "description" value = "<%= description %>">
 </div>
 ...
 <div class="form-group">
 	<div class = "row">
 		...
 		<div class = "col-md-6">
    			...
    			<input type="date" class="form-control" id="year"  placeholder="Enter published year" name = "date" value = "<%= date %>">
 		</div>
...
<button type="submit" name ="updateN" value = "Update profile" class="btn btn-success btn-block btn-sm">Update News Details</button>
