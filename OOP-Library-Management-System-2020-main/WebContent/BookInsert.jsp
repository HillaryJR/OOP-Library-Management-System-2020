...
<br><br>
            <header>
                <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
                    <div>
                        <a href="#" class="navbar-brand">Insert New Book</a>
                    </div>
...
<div class = "container">
	<div class = "row">
		...
		<div class = "col-lg-4">
					<ul>
                        <li><a href="<%=request.getContextPath()%>/BookListServlet">
...
<div class="form-group">
  ...
  <label for="categoryNum">Enter Book Category</label>
	<select name="categoryNum" class="form-control" required>
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" id="bookname"  placeholder="Enter the Book name" name = "bookname" required>
 </div>
 
  <div class="form-group">
    <label for="bookauthor">Enter Author name</label>
    <input type="text" class="form-control" id="bookauthor"  placeholder="Enter name of author" name = "bookauthor" required>
 </div>
 
  <div class="form-group">
    <label for="edition">Book Edition</label>
    <input type="text" class="form-control" id="edition"  placeholder="Enter book edition" name = "edition" required>
 </div>
