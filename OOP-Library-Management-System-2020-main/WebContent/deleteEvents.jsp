...
<br><br>
            <header>
                <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
                    <div>
                        <a href="#" class="navbar-brand">Delete This Library Event</a>
                    </div>
		...
		%>
		<div class ="eventFormCon1">
			<br/>
			<center>
				<div class="mgk1">
					
					<form method="post" action="delete">
						<label class="evid1d">Event Code</label><br>
						<input type="text" name="eCode" id="evid1xd" value="<%= id %>" readonly></input><br><br> 
						
						<center><button type="submit" id="btnregisterD" >Delete this event</button></center>
					</form>
				</div>
			</center>
        </div><br><br><br>
