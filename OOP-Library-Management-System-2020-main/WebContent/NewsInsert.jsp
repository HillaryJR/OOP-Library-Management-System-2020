...
<br><br>
            <header>
                <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
                    <div>
                        <a href="#" class="navbar-brand">Insert News</a>
                    </div>
...
<div class = "container">
	<div class = "row">
		...
		<div class = "col-lg-4">
					<ul>
                        <li><a href="<%=request.getContextPath()%>/NewsListServlet">
...
<br>
 ...
 <div class="form-group">
    <label for="topic">Enter news topic</label>
    <input type="text" class="form-control" id="topic"  placeholder="Enter the topic" name = "topic" required>
 </div>
 
  <div class="form-group">
    <label for="description">Enter news description</label>
    <input type="text" class="form-control" id="description"  placeholder="Enter the description" name = "description" required>
 </div>
 ...
 <div class="form-group">
 	<div class = "row">
 		...
 		<div class = "col-md-6">
     			...
     			<input type="date" class="form-control" id="date"  placeholder="Enter the news date" name = "date" required> 	
 		</div>
...
<script type="text/javascript">
 ...
 <label for="validationDefault03">Choose an Image for the news</label>
            Upload image input
