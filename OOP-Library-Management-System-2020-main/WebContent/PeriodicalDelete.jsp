...
<br><br>
            <header>
                <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
                    <div>
                        <a href="#" class="navbar-brand">Delete Periodical Detail</a>
                    </div>
...
<div class="form-group">
    <label for="type">Periodical Type</label>
    <input type="text" class="form-control" id="type"  placeholder="Enter the Category" name = "type" value = "<%= type %>" readonly>
 </div>
 
 <div class="form-group">
    <label for="name">Periodical Name</label>
    <input type="text" class="form-control" id="name"  placeholder="Enter the Book name" name = "name" value = "<%= name %>" readonly>
 </div>
 
  <div class="form-group">
    <label for="publication">Periodical Publication</label>
    <input type="text" class="form-control" id="publication"  placeholder="Enter name of author" name = "publication" value = "<%= publication %>" readonly>
 </div>
 
  <div class="form-group">
    <label for="edition">Periodical Edition</label>
    <input type="text" class="form-control" id="edition"  placeholder="Enter book edition" name = "edition" value = "<%= edition %>" readonly>
 </div>
 	...
 	<div class = "row">
 		<div class = "col-md-6">
 			 <label for="price">Enter Periodical Price</label>
  			  <input type="text" class="form-control" id="price"  placeholder="Enter book price" name = "price" value = "<%= price %>" readonly>
 		</div>
 		<div class = "col-md-6">
 			    <label for="year">Published Date</label>
    			<input type="text" class="form-control" id="year"  placeholder="Enter published year" name = "year" value = "<%= year %>" readonly>
 		</div>
 	</div>
 </div>
...
<!--  <label for="validationDefault03">Choose a book image</label>
            ...
            <div class="input-group rounded bg-white shadow-sm">
               id="upload"
                ...
                <input  id="upload" type="file" onchange="readURL(this);" class="form-control border-0" name="filename" value="filename" readonly>
  ...
  <label id="upload-label" for="upload" class="font-weight-light text-muted" >Browse</label> 
   <input  id="upload" type="file" onchange="loadFile(event)" class="form-control border-0" class="form-control" name="filename" value="filename" readonly>
...
<!--             Uploaded image area -->
            <p class="font-italic text-white text-center">Cover Page</p>
...
<div class="form-group col-md-4">  </div></div>
					...
					<button type="submit" name ="delete" value = "Delete Book" class="btn btn-primary btn-block btn-sm">Delete Book</button>
