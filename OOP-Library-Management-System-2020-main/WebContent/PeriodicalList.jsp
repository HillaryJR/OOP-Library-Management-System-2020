...
<br><br>
            <header>
                <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
                    <div>
                        <a href="#" class="navbar-brand">Periodical List</a>
                    </div>
...
<table class="table table table-hover table-dark table-bordered table-sm text-center ">
                        <thead>
                            <tr>
                                <th>ID</th>
                        ...
                        <tbody>
                            <!--   for (Todo todo: todos) {  -->
                            <c:forEach var="periodical" items="${listPeriodical}">
                            
                            <c:set var = "id" value = "${periodical.id}"/>
		<c:set var = "type" value = "${periodical.type}"/>
		<c:set var = "name" value = "${periodical.name}"/>
		<c:set var = "publication" value = "${periodical.publication}"/>
		<c:set var = "edition" value = "${periodical.edition}"/>
		<c:set var = "price" value = "${periodical.price}"/>
		<c:set var = "year" value = "${periodical.year}"/>
		<c:set var = "filename" value = "${periodical.filename}"/>
		
		
		
		
		 <c:url value = "PeriodicalUpdate.jsp" var = "periodicalupdate">
			<c:param name="id" value = "${id}"/>
			<c:param name="type" value = "${type}"/>
			<c:param name="name" value = "${name}"/>
			<c:param name="publication" value = "${publication}"/>
		...
		<c:url value = "PeriodicalDelete.jsp" var = "periodicaldelete">
			<c:param name="id" value = "${id}"/>
			<c:param name="type" value = "${type}"/>
			<c:param name="name" value = "${name}"/>
			<c:param name="publication" value = "${publication}"/>
			...
			<c:param name="filename" value = "${filename}"/>
                                ...
                                <tr class = "tableRow">
                                    ...
                                    <td>
                                    <div class = "tableRowww">
                                        <c:out value="${periodical.publication}" />
                                     </div>   
                                    </td>
                                    <td>
                                    <div class = "tableRowww">
                                        <c:out value="${periodical.edition}" />
                                     </div>  
                                    </td>
                                    <td>
                                    <div class = "tableRowww">
                                    ...
                                    <td>
                                    <div class = "tableRowww">
                                       <c:out value="${periodical.year}" />
                                    </div>   
                                    </td>
                                    
                                    <td>
										<image src = "images/<c:out value="${periodical.filename}" />" width = "80", height = "130"/> 
                                    </td>
...
<button type="submit" class="btn btn-primary btn-block">
	<a href="PeriodicalInsert.jsp">Add Periodical</a>
</button>
