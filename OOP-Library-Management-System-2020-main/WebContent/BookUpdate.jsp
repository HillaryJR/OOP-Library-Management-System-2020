...
<div class="form-group">
    <label for="categoryNum">Book ID</label>
 ...
 <div class="form-group">
  ...
  <label for="categoryNum">Enter Book Category</label>
	<select name="categoryNum" class="form-control"  value = "<%= categoryNum %>" required>
	 <option value = "<%= categoryNum %>" disabled selected hidden><%= categoryNum %></option>
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" id="bookname"  placeholder="Enter the Book name" name = "bookname" value = "<%= bookname %>">
 </div>
 
  <div class="form-group">
    <label for="bookauthor">Enter Author name</label>
    <input type="text" class="form-control" id="bookauthor"  placeholder="Enter name of author" name = "bookauthor" value = "<%= bookauthor %>">
 </div>
...
<button type="submit" name ="update" value = "Update profile" class="btn btn-success btn-block btn-sm">Update Book Details</button>
