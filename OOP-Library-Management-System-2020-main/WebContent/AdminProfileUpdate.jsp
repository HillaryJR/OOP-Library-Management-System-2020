...
<br><br>
            <header>
                <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
                    <div>
                        <a href="#" class="navbar-brand">Update Admin Detail</a>
                    </div>
	...
	<div class = "container">
		<div class = "card text-white special-card">
			<div class = "card-body">
					<form action="updateA" method ="post" enctype="multipart/form-data" >

	
<div class="form-group">
    <label for="id">Admin ID</label>
    <input type="text" class="form-control" id="id"  placeholder="ADMIN ID" name = "id"  value = "<%= id %>" readonly>
</div>
 ...
 <div class="form-group">
  ...
  <input type="text" class="form-control" id="username"  placeholder="Username" name = "username" value = "<%= username %>" readonly>
  </div>
...
<button type="submit" name ="update" value = "Update profile" class="btn btn-success btn-block btn-sm">Update Details</button>
