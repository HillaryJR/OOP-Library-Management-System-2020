...
<br><br>
            <header>
                <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
                    <div>
                        <a href="#" class="navbar-brand">Delete Staff Detail</a>
                    </div>
...
<div class="form-group">
    <label for="categoryNum">Staff ID</label>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="fname"  placeholder="fname" name = "fname" value = "<%= fname %>" readonly>
 </div>
 
 <div class="form-group">
    <label for="lname">Last Name</label>
    <input type="text" class="form-control" id="lname"  placeholder="lname" name = "lname" value = "<%= lname %>" readonly>
 </div>
 
  <div class="form-group">
    <label for="mobile">Mobile Number</label>
    <input type="text" class="form-control" id="mobile"  placeholder="mobile" name = "mobile" value = "<%= mobile %>" readonly>
 </div>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="address"  placeholder="address" name = "address" value = "<%= address %>" readonly>
 </div>
 
   <div class="form-group">
    <label for="role">Job Specification</label>
    <input type="text" class="form-control" id="role"  placeholder="role" name = "role" value = "<%= role %>" readonly>
 </div>
...
<div class="form-group col-md-4"></div>
			...
			<button type="submit" name ="delete" value = "Delete Book" class="btn btn-primary btn-block btn-sm">Remove Staff</button>
	</form>
