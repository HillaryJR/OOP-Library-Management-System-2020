...
<br><br>
            <header>
                <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
                    <div>
                        <a href="#" class="navbar-brand">Insert New Library Staff</a>
                    </div>
...
<br>
	...
	<div class = "container">
		<div class = "card text-white special-card">
			<div class = "card-body">
					<form action="insertS" method ="post" enctype="multipart/form-data">


 
 <div class="form-group">
    <label for="fname">Enter First Name</label>
    <input type="text" class="form-control" id="fname"  placeholder="Enter the Fist name" name = "fname" required>
 </div>
 
  <div class="form-group">
    <label for="lname">Enter last Name</label>
    <input type="text" class="form-control" id="lname"  placeholder="Enter the last name" name = "lname" required>
 </div>
 
  <div class="form-group">
    <label for="mobile">Enter Mobile Number</label>
    <input type="text" class="form-control" id="mobile"  placeholder="Enter the Mobile Number" name = "mobile" required>
 </div>
...
<div class="form-group">
  ...
  <label for="role">Job Specification(Role)</label>
...
<div class = "form-row">
 ...
 <label for="validationDefault03">Choose a profile image</label>
            Upload image input
