...
<br><br>
            <header>
                <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
                    <div>
                        <a href="#" class="navbar-brand">Delete News Detail</a>
                    </div>
	...
	<div class = "container">
		<div class = "card text-white special-card">
			<div class = "card-body">
					<form action="deleteN" method ="post" >

<div class="form-group">
    <label for="categoryNum">News ID</label>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="topic"  placeholder="Enter the Category" name = "topic" value = "<%= topic %>" readonly>
 </div>
 
 <div class="form-group">
    <label for="description">News Description</label>
    <input type="text" class="form-control" id="description"  placeholder="Enter the Book name" name = "description" value = "<%= description %>" readonly>
 </div>
 ...
 <div class="form-group">
 	<div class = "row">
 		...
 		<div class = "col-md-6">
    			...
    			<input type="text" class="form-control" id="date"  placeholder="Enter published year" name = "date" value = "<%= date %>" readonly>
 		</div>
...
<div class="form-group col-md-4">  </div></div>
					...
					<button type="submit" name ="delete" value = "Delete News" class="btn btn-primary btn-block btn-sm">Delete News</button>
