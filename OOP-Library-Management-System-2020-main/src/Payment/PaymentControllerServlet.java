...
public class PaymentControllerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
 	...
 	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = PaymentDButil.insertPaymentDetails(username ,name, type, cardNo, expMonth, expYear, cvv, payName);
		...
		if(isTrue == true){
			...
			RequestDispatcher dis = request.getRequestDispatcher("successpay.jsp");
